...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1320.0, 125.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1245.0, 546.5, 231.0, 22.0 ],
					"text" : "jit.gl.light @direction 1 0 -1 @diffuse 0 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1245.0, 515.5, 237.0, 22.0 ],
					"text" : "jit.gl.light @direction 0 1 1 @diffuse 0 0.3 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1245.0, 480.0, 231.0, 22.0 ],
					"text" : "jit.gl.light @direction -1 1 0 @diffuse 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1320.0, 153.5, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.5, 210.0, 53.0, 22.0 ],
					"text" : "s render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1245.0, 153.5, 51.0, 22.0 ],
					"text" : "r render"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 195.0, 77.0, 22.0 ],
									"text" : "vec 0.1 0 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 135.0, 77.0, 22.0 ],
									"text" : "scale 0.2 0.7"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 450.0, 375.0, 35.0, 22.0 ],
									"text" : "out 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 330.0, 330.0, 57.0, 22.0 ],
									"text" : "vec 0 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 330.0, 375.0, 35.0, 22.0 ],
									"text" : "out 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 45.0, 107.0, 22.0 ],
									"text" : "param distance 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 195.0, 61.0, 22.0 ],
									"text" : "* distance"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 105.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 375.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 1245.0, 255.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1245.0, 210.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1245.0, 406.0, 250.0, 49.0 ],
					"text" : "jit.gl.gridshape scn @shape cube @color 1 1 1 1 @automatic 0 @lighting_enable 1 @fog 1 @fog_color 0 0 0 0 @fog_range 4 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1245.0, 345.0, 251.0, 35.0 ],
					"text" : "jit.gl.multiple scn 4 @glparams position scale rotatexyz color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 897.0, 240.0, 275.0, 22.0 ],
					"text" : "jit.anim.drive @ui_listen 1 @speed 1.5 @ease 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 897.0, 279.5, 212.0, 35.0 ],
					"text" : "jit.gl.camera @position 0 0 4 @locklook 1 @lookat 0 0 0 @tripod 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 870.0, 200.5, 337.0, 22.0 ],
					"text" : "jit.gl.node @capture 1 @name scn @dim 1280 720 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 360.0, 30.0, 123.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 360.0, 93.5, 121.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.5, 497.0, 39.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 77.0, 465.0, 41.0, 22.0 ],
					"text" : "sel 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 77.0, 435.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 255.0, 54.0, 22.0 ],
					"text" : "s enable"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 870.0, 660.0, 69.0, 22.0 ],
					"text" : "s imageTex"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 298.5, 236.0, 67.0, 22.0 ],
					"text" : "r imageTex"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 371.0, 206.0, 33.0 ],
...
,
					"patching_rect" : [ 897.0, 365.5, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 949.0, 336.5, 95.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 961.5, 541.0, 253.5, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 909.5, 546.5, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1002.5, 577.0, 220.0, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 77.0, 495.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 525.0, 55.0, 22.0 ],
					"text" : "invert $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 949.0, 576.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 897.0, 335.5, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 45.0, 300.0, 312.0, 22.0 ],
					"text" : "jit.gl.node asciiArt @capture 1 @dim 1280 720 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "jit_matrix", "jit_matrix", "jit_matrix", "jit_matrix", "" ],
					"patching_rect" : [ 298.5, 345.0, 69.0, 22.0 ],
					"text" : "jit.unpack 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 298.5, 266.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 870.0, 410.5, 194.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 77.0, 900.0, 150.0, 22.0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "degrade.genjit",
				"bootpath" : "~/Documents/Max 8/Library/abstractions/gl-pix-shaders/code",
				"patcherrelativepath" : "../../../../../../Documents/Max 8/Library/abstractions/gl-pix-shaders/code",
				"type" : "gJIT",
				"implicit" : 1
			}
, 			{
